...
| Функция   | Объявление функции                           | Описание                                                                        |
| ---------------- | ------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| create_matrix    | int create_matrix(int rows, int columns, matrix_t *result)    | Создание матрицы                                                        |
| remove_matrix    | void remove_matrix(matrix_t *A)                               | Удаление матрицы                                                         |
| eq_matrix        | int eq_matrix(matrix_t *A, matrix_t *B)                       | Сравнение двух матриц                                                |
| sum_matrix       | int sum_matrix(matrix_t *A, matrix_t *B, matrix_t *result)    | Сложение двух матриц                                                  |
| sub_matrix       | int sub_matrix(matrix_t *A, matrix_t *B, matrix_t *result)    | Вычетание двух матриц                                                |
| mult_number      | int mult_number(matrix_t *A, double number, matrix_t *result) | Умножение матрицы на число                                       |
| mult_matrix      | int mult_matrix(matrix_t *A, matrix_t *B, matrix_t *result)   | Умножение двух матриц                                                |
| transpose        | int transpose(matrix_t *A, matrix_t *result)                  | Транспонирование матрицы                                         |
| determinant      | int determinant(matrix_t *A, double *result)                  | Вычисление определителя матрицы                            |
| calc_complements | int calc_complements(matrix_t *A, matrix_t *result)           | Вычисление матрицы алгребраический дополнений |
| inverse_matrix   | int inverse_matrix(matrix_t *A, matrix_t *result)             | Поиск обратной матрицы                                              |
