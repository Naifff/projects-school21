...
START_TEST(sprintf_test_many_hex_lower) {
  ...
  ck_assert_int_eq(s21_sprintf(str1, "%x%x%x%x", 12340987, 135, 0, -1230),
                   sprintf(str2, "%x%x%x%x", 12340987, 135, 0, -1230));
  ck_assert_str_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_test_many_hex_lower_with_alignment) {
  ...
  // ck_assert_int_eq(
  //     s21_sprintf(str1, "%2x%-7x%9x%11x", 12340987, 100, 0, 1),
  //     sprintf(str2, "%2x%-7x%9x%11x", 12340987, 100, 0, 1));
  ck_assert_int_eq(s21_sprintf(str1, "%2x%-7x%9x%11x", 12340987, 100, 0, 1),
                   sprintf(str2, "%2x%-7x%9x%11x", 12340987, 100, 0, 1));
  ck_assert_str_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_test_many_hex_lower_with_width_star_and_align_and_hashtag) {
  ...
  ck_assert_int_eq(s21_sprintf(str1, "%#*x%*x%-12x", 9, 127312897, 0, -1, 199),
                   sprintf(str2, "%#*x%*x%-12x", 9, 127312897, -0, -1, 199));
  ck_assert_str_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_test_many_hex_lower_with_precision_and_other) {
  ...
  char str2[BUFF_SIZE];
  int a =
      s21_sprintf(str1, "%#3.*x%#3x%-7.*x%#-1.8x%4.3x%#2.15x%*.*x%*.1x", 3,
                  126714, 4444444, 0, 6423235, 0, 666, 999, 13, 5, 419, 9, 41);
  int b = sprintf(str2, "%#3.*x%#3x%-7.*x%#-1.8x%4.3x%#2.15x%*.*x%*.1x", 3,
                  126714, 4444444, 0, 6423235, 0, 666, 999, 13, 5, 419, 9, 41);
  ck_assert_int_eq(a, b);
  ck_assert_str_eq(str1, str2);
}
...
START_TEST(sprintf_test_many_hex_upper_with_precision_and_other) {
  ...
  ck_assert_int_eq(
      s21_sprintf(str1, "%#3.*X%#3x%-7.*X%#-1.8X%4.3X%#2.15x%*.*X%*.1X", 3,
                  126714, 4444444, 0, 6423235, 0, 666, 999, 13, 5, 419, 9, 41),
      sprintf(str2, "%#3.*X%#3x%-7.*X%#-1.8X%4.3X%#2.15x%*.*X%*.1X", 3, 126714,
              4444444, 0, 6423235, 0, 666, 999, 13, 5, 419, 9, 41));
  ck_assert_str_eq(str1, str2);
}
END_TEST
...
Suite *suite_insert(void) {
  ...
  */
  ...
  tcase_add_test(tc, sprintf_test_sprintf45);
  // tcase_add_test(tc, sprintf_test_sprintf46);
