...
START_TEST(test_s21_buh) {
  ...
  int error = s21_bank_round(buffer1, &buflen, 0);
  ...
  error = s21_bank_round(buffer2, &buflen, 0);
  ...
  error = s21_bank_round(buffer3, &buflen, 0);
  ...
  buflen = 10;
  error = s21_bank_round(buffer4, &buflen, 0);
  ck_assert_int_eq(error, error);
  ...
  error = s21_bank_round(buffer5, &buflen, 0);
  ...
  buflen = 21, rez_buflen = 0;
  error = s21_bank_round(buffer6, &buflen, 0);
  ...
  error = s21_bank_round(buffer7, &buflen, 0);
  ...
  buflen = 21, rez_buflen = 1;
  error = s21_bank_round(buffer8, &buflen, 0);
  ...
  buflen = 21, rez_buflen = 1;
  error = s21_bank_round(buffer9, &buflen, 0);
  ...
  buflen = 21, rez_buflen = 0;
  error = s21_bank_round(buffer10, &buflen, 0);
  ...
  error = s21_bank_round(buffer11, &buflen, 0);
  ...
  buflen = 28;
  error = s21_bank_round(buffer16, &buflen, 0);
  ...
  buflen = 30;
  error = s21_bank_round(buffer17, &buflen, 0);
...
START_TEST(test_s21_dec_to_int) {
  ...
  val.bits[1] = 0b00000000000000000000000000000000;
  val.bits[2] = 0b00000000000000000000000000000000;
  val.bits[3] = 0b00000000000001000000000000000000;
  s21_from_decimal_to_int(val, &rez);
